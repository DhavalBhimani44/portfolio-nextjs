...
export default function ContentList({ items, contentType, fallbackItemImage, viewMore = "Read More" } : ContentListProps) {
    ...
    const contentImages = items.map((items) => {
        const image = isFilled.image(items.data.hover_image) ? items.data.hover_image : fallbackItemImage;
                        ...
                        {isFilled.keyText(item.data.title) && (
                            ...
                            >
                                <Link 
                                    ...
                                    <span className='flex ml-auto items-center gap-2 text-xl font-medium md:ml-0'>{viewMore} <MdArrowOutward/></span>
                                </Link>    
                            </li>
                        )}
                    </>
